...
function ArchitectPaymentTable(props) {
    const history = useHistory();

    const CardTypeImage = (cardType) => {
        switch (cardType) {
            case 'mastercard':
                return <img src={require("../../../assets/img/mastercard.png")} width="60" height="30"
                            alt="Mastercard"/>
            case 'visa':
                return <img src={require("../../../assets/img/visa-512.png")} width="60" height="30" alt="Mastercard"/>
            case 'discover':
                return <img src={require("../../../assets/img/discover-credit-debit-card-bank-transaction-32285.png")}
                            width="80" height="50" alt="Mastercard"/>
            default:
                return <img src="../../../assets/img/mastercard.png"/>
        }
    }
...
export default ArchitectPaymentTable;